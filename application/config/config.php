...
if($_SERVER['HTTP_HOST'] == 'localhost') {
	$config['base_url']	= "http://" . $_SERVER['SERVER_NAME'] . "/github/scorporativo/";
} else {
...
$config['site_title'] = 'Site Corporativo';
...
$config['email_bg'] = '#EEEEEE';
//largura do slide
$config['slide_width'] = '960';
//altura do slide
$config['slide_height'] = '300';
...
|
*/
$config['permitted_uri_chars'] = 'a-z 0-9~%.:_\+\-áéíóúçâêôûãõàäëïöü|@';
...
$config['sess_cookie_name'] = $config['_prefix'].'session';
